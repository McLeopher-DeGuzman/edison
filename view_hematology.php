	...
	<div class = "well">
		...
		<div class = "panel panel-success">	
			...
			?>
				...
				<a style = "float:right; margin-top:-4px;" href = "hematology.php" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a>
				<a style = "float:right; margin-top:-4px; margin-right:5px;" href = "hematology_pending.php?itr_no=<?php echo $f['itr_no']?>" class = "btn btn-info">REQUEST <span class = "badge"> <?php echo $f1['total']?></span></a>
			...
			<div class = "panel-body">
					...
					<div class = "form-group" style = "width:15%; float:left;">
						<label style = "font-size:18px;" for = "bp">BLOOD PRESSURE</label>
						<br />
						<label style = "font-size:18px;" class = "text-muted"><?php echo $f['BP']?></label>
					</div>
					<div class = "form-group" style = "width:15%; float:left;">
						<label style = "font-size:18px;" for = "temp">TEMPERATURE</label>
						<br />
						<label style = "font-size:18px;" class = "text-muted"><?php echo $f['TEMP']?></label>
					</div>
					<div class = "form-group" style = "width:15%; float:left;">	
						<label style = "font-size:18px;" for = "pr">PULSE RATE</label>
						<br />
						<label style = "font-size:18px;" class = "text-muted"><?php echo $f['PR']?></label>
					</div>
					<div class = "form-group" style = "width:15%; float:left;">	
						<label style = "font-size:17px;" for = "rr">RESPIRATORY RATE</label>
						<br />
