	...
	<div id = "content">
		...
		<div style = "display:none;" id = "add_itr" class = "panel panel-success">	
			<div class = "panel-heading">
				<label>ADD PATIENT'S INFORMATION</label>
			...
			<div class = "panel-body">
				<form id = "form_dental" method = "POST" enctype = "multipart/form-data">
					...
					<div class = "form-inline">
						...
						<br />
						<br />
						<label for = "rr">RESPERTORY RATE:</label>
				...
				<table id = "table" class = "display" width = "100%" cellspacing = "0">
					...
					?>
						<tr>
							...
							<td>
    <center>
        <a href = "print.php?id=<?php echo $fetch['itr_no']?>&lastname=<?php echo $fetch['lastname']?>" class = "btn btn-sm btn-success" target="_blank"><span class = "glyphicon glyphicon-print"></span> Print</a> 
        <a href = "delete_patient.php?id=<?php echo $fetch['itr_no']?>&lastname=<?php echo $fetch['lastname']?>" class = "btn btn-sm btn-danger"><span class = "glyphicon glyphicon-trash"></span> Delete</a>
    </center>
</td>
						</tr>
					<?php
